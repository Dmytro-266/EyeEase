...
namespace EyeNurse.Services
{
    ...
    public class EyeNurseService
    {
        ...
        readonly HotkeyService _hotkeyService;
        #endregion

        #region construct

        public EyeNurseService(AppService appService, ConfigService configService, HotkeyService hotkeyService)
        {
            ...
            _desktopStartupHelper = new("EyeEase", exePath);
        }
        ...
        public EventHandler? HotkeyTriggered;
        #endregion
        ...
        internal void ApplySetting(UserConfigs.Setting setting)
        {
            ...
            _hotkeyService.Register(setting.PauseHotkey, () => HotkeyTriggered?.Invoke(this, EventArgs.Empty));
